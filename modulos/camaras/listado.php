                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Camaras</h3>
                                    ...
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            <?php foreach ($listadoCamara as $camara): ?>
                                                <tr>
                                                    <td><?php echo $camara->getModelos();?></td>
                                                    <td><a href="detalle.php?id=<?php echo $camara->getIdCamara()?>"><img src="../../imagenes/detalle.png"></a> <a href="modificar.php?id=<?php echo $camara->getIdCamara()?>"><img src="../../imagenes/ajustes.png"></a> <a href="procesar/eliminar.php?id=<?php echo $camara->getIdCamara()?>"><img src="../../imagenes/dejar.png"></a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
