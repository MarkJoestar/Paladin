                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Camaras</strong> Modificacion
                                    </div>
                                        ...
                                        <form id="frmDatos" name="frmDatos" action="procesar/modificar.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="txtModelo" name="txtModelo" placeholder="Ingese modelo de la Camara" class="form-control" value="<?php echo $camara->getModelos(); ?>">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
