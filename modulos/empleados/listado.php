                                ...
                                <div class="table-data__tool">
                                    <div class="table-data__tool-right">
                                    		<?php if ($mensaje == EMPLEADO_GUARDADO): ?>
                                    			<h3><img src="../../imagenes/pulgar.png">Empleado Guardado</h3>
                                    			<br>
                                    			<br>
                        ...
                        <div class="row m-t-30">
                            <div class="col-md-12">
                                        ...
                                        <tbody>
                                            <?php foreach ($listadoEmpleado as $empleado): ?>
                                                <tr>
                                                    ...
                                                    <td><a href="detalle.php?id=<?php echo $empleado->getIdEmpleado()?>"><img src="../../imagenes/detalle.png"></a> <a href="modificar.php?id=<?php echo $empleado->getIdEmpleado()?>"><img src="../../imagenes/ajustes.png"></a> <a href="procesar/eliminar.php?id=<?php echo $empleado->getIdEmpleado()?>"><img src="../../imagenes/dejar.png"></a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
                                ...
                                <div class="user-data__footer">
                                        <a href="../../informe2.php">
                                    <button class="au-btn au-btn-load">Asistencia</button></a>
                                    <a href="../../informe.php">
                                    <button class="au-btn au-btn-load">Puntualidad</button></a>
                                </div>
                                <!-- END DATA TABLE-->
                            </div>
                        </div>
