                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Funciones</strong> Modificacion
                                    </div>
                                    <div class="card-body card-block">
                                        <form id="frmDatos" name="frmDatos" action="procesar/modificar.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            <input type="hidden" name="txtId" value="<?php echo $funcion->getIdFuncion(); ?>">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Descripcion</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="txtDescripcion" name="txtDescripcion" placeholder="Ingese la descripcion de la funcion" class="form-control" value="<?php echo $funcion->getDescripcion(); ?>">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
