                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Modulos</h3>
                                        ...
                                        <tbody>
                                            <?php foreach ($listadoModulo as $modulo): ?>
                                                <tr>
                                                    ...
                                                    <td><a href="detalle.php?id=<?php echo $modulo->getIdModulo()?>"><img src="../../imagenes/detalle.png"></a> <a href="modificar.php?id=<?php echo $modulo->getIdModulo()?>"><img src="../../imagenes/ajustes.png"></a> <a href="procesar/eliminar.php?id=<?php echo $modulo->getIdModulo()?>"><img src="../../imagenes/dejar.png"></a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
