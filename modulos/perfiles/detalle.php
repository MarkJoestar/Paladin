                                    ...
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <p class="form-control-static"><?php echo $perfil->getIdPerfil();?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <p class="form-control-static"><?php echo $perfil->getNombre();?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label"><strong>Modulos:</strong></label>
                                            </div>
                                            <div class="col-12 col-md-9">
