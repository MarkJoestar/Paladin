                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Perfil</h3>
                                        ...
                                        <tbody>
                                            <?php foreach ($listadoPerfiles as $perfil): ?>
                                                <tr>
                                                    ...
                                                    <td><a href="detalle.php?id=<?php echo $perfil->getIdPerfil()?>"><img src="../../imagenes/detalle.png"></a> <a href="modificar.php?id=<?php echo $perfil->getIdPerfil()?>"><img src="../../imagenes/ajustes.png"></a> <a href="procesar/eliminar.php?id=<?php echo $perfil->getIdPerfil()?>"><img src="../../imagenes/dejar.png"></a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
