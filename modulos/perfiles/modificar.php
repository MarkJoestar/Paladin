                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Perfil</strong> Modificacion
                                    </div>
                                        ...
                                        <form id="frmDatos" name="frmDatos" action="procesar/modificar.php" method="POST" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="txtNombre" name="txtNombre" placeholder="Ingese el nombre del modulo" class="form-control" value="<?php echo $perfil->getNombre(); ?>">
                                                </div>
                                                <div class="col col-md-3">
                                                <label for="multiple-select" class=" form-control-label">Modulos</label>
                                                </div>
                                                <div class="col col-md-9">
                                                    <select name="cboModulos[]" multiple="" class="form-control">
