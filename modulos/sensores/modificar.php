                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Sensores</strong> Modificacion
                                    </div>
                                    <div class="card-body card-block">
                                        <form id="frmDatos" name="frmDatos" action="procesar/modificar.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            <input type="hidden" name="txtId" value="<?php echo $sensor->getIdSensor(); ?>">
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label class=" form-control-label">Modelo</label>
                                                </div>
                                                <div class="col-12 col-md-9">
                                                    <input type="text" id="txtModelo" name="txtModelo" placeholder="Ingese modelo del sensor" class="form-control" value="<?php echo $sensor->getModelo(); ?>">
                                                </div>
                                            </div>
                                        </form>
                                    </div>
