                                        ...
                                        <form id="frmDatos" name="frmDatos" action="procesar/guardar.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="txtDescripcion" id="txtDescripcion" rows="5" placeholder="Inserte la descripcion de la ubicacion" class="form-control"></textarea>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
