                ...
                <div class="section__content section__content--p30">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-12">
                                <!-- DATA TABLE -->
                                <h3 class="title-5 m-b-35">Ubicaciones</h3>
                                <div class="table-data__tool">
                                    <div class="table-data__tool-right">
                                    		<?php if ($mensaje == UBICACION_GUARDADA): ?>
                                    			...
                                    			<br>
                                    			<br>
                                    		<?php elseif ($mensaje == UBICAION_MODIFICADA): ?>
                                        ...
                                        <tbody>
                                            <?php foreach ($listadoUbicacion as $ubicacion): ?>
                                                <tr>
                                                    ...
                                                    <td><a href="detalle.php?id=<?php echo $ubicacion->getIdUbicacion()?>"><img src="../../imagenes/detalle.png"></a> <a href="modificar.php?id=<?php echo $ubicacion->getIdUbicacion()?>"><img src="../../imagenes/ajustes.png"></a> <a href="procesar/eliminar.php?id=<?php echo $ubicacion->getIdUbicacion()?>"><img src="../../imagenes/dejar.png"></a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
