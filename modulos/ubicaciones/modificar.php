                            ...
                            <div class="col-lg-6">
                                <div class="card">
                                    <div class="card-header">
                                        <strong>Ubicaciones</strong> Modificacion
                                    </div>
                                        ...
                                        <form id="frmDatos" name="frmDatos" action="procesar/modificar.php" method="POST" enctype="multipart/form-data" class="form-horizontal">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="txtDescripcion" id="txtDescripcion" rows="5" placeholder="Inserte la descripcion de la ubicacion" class="form-control" value="<?php echo $ubicacion->getDescripcion(); ?>"></textarea>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
