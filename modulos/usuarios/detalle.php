                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <p class="form-control-static"><?php echo $user->getIdUsuario();?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body card-block">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <p class="form-control-static"><?php echo $user->getPassword();?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <p class="form-control-static"><?php echo $user->getNombre();?></p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-body card-block">
                                        <div class="row form-group">
                                            ...
                                            <div class="col-12 col-md-9">
                                                <p class="form-control-static"><?php echo $user->getApellido();?></p>
                                            </div>
                                        </div>
                                        <div class="card-body card-block">
                                        <div class="row form-group">
                                            <div class="col col-md-3">
                                                <label class=" form-control-label"><strong>Imagen de Perfil:</strong></label>
                                            </div>
                                            <div class="col-12 col-md-9">
