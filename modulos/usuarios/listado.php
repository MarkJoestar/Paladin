...
$listadosUsusarios = Usuario::obtenerTodos();
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="table-responsive m-b-40">
                                    <table class="table table-borderless table-data3">
                                        ...
                                        <tbody>
                                            <?php foreach ($listadosUsusarios as $usuario): ?>
                                                <tr>
                                                    <td><?php echo $usuario->getNombre();?></td>
                                                    <td><?php echo $usuario->getApellido();?></td>
                                                    <td><?php echo $usuario->getUsername();?></td>
                                                    <td><a href="detalle.php?id=<?php echo $usuario->getIdUsuario()?>"><img src="../../imagenes/detalle.png"></a> <a href="modificar.php?id=<?php echo $usuario->getIdUsuario()?>"><img src="../../imagenes/ajustes.png"></a> <a href="procesar/eliminar.php?id=<?php echo $usuario->getIdUsuario()?>"><img src="../../imagenes/dejar.png"></a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
